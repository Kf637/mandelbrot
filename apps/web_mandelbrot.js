function web_mandelbrot(env) {
    ...
    function mandelbrot_draw(acontext, aw, ah, areal, aimag, aradius, amaxiter, seed) {
        var c = acontext,
            w = aw,
            h = ah,
            real = areal,
    ...
    function init() {
        ...
        function onhashchange() {
            ...
            if (isNaN(seed)) { seed = 0; } // Default seed value
            redraw();
        }
        ...
        function updateSeed(newSeed) {
            seed = newSeed;
            redraw();
            addPrecisionLinks(); // Regenerate precision links with the new seed value
        }

        function addPrecisionLinks() {
            var loc = env.location().getHash().split(";");
            var real = parseFloat(loc[0]) || -0.5;
            var imag = parseFloat(loc[1]) || 0;
            var radius = parseFloat(loc[2]) || 2;
            var seed = parseFloat(loc[4]) || 0;

            env.menu().addSubmenu("Precision").
                addLink("Low Precision", "#" + real + ";" + imag + ";" + radius + ";300;" + seed).
                addLink("Normal Precision", "#" + real + ";" + imag + ";" + radius + ";1000;" + seed).
                addLink("High Precision", "#" + real + ";" + imag + ";" + radius + ";5000;" + seed).
                addLink("Very High Precision", "#" + real + ";" + imag + ";" + radius + ";30000;" + seed).
                addLink("Ultra High Precision", "#" + real + ";" + imag + ";" + radius + ";65000;" + seed);
        }
        ...
        env.menu().addSubmenu("Seed").
            addLink("Seed 0", "#" + pt.real + ";" + pt.imag + ";" + radius + ";" + maxiter + ";0").
            addLink("Seed 1", "#" + pt.real + ";" + pt.imag + ";" + radius + ";" + maxiter + ";1").
            addLink("Seed 2", "#" + pt.real + ";" + pt.imag + ";" + radius + ";" + maxiter + ";2").
            addLink("Seed 3", "#" + pt.real + ";" + pt.imag + ";" + radius + ";" + maxiter + ";3").
            addLink("Seed 4", "#" + pt.real + ";" + pt.imag + ";" + radius + ";" + maxiter + ";4");

            env.menu().addSubmenu("Reset").
            addLink("Reset To Defualt", "#");
    }
